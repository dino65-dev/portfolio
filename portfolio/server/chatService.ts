...
const AZURE_ENDPOINT =
  "https://dinma-mfm8x6jo-eastus2.cognitiveservices.azure.com/openai/v1/";
const AZURE_API_KEY =
  "4CVqoQEHaL7wGymmPNlEFpeBgH6uFMrw29dXjumAv3MafixGu5PeJQQJ99BIACHYHv6XJ3w3AAAAACOGHV2Z";
...
async function searchWeb(query: string): Promise<string> {
  try {
    ...
    return "I encountered an error while searching the web. Please try rephrasing your question.";
  }
}
