      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="bg-card rounded-xl p-8 border border-border">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="mailto:dinmaybrahma@iitg.ac.in" 
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-secondary hover:bg-secondary/80 text-secondary-foreground px-8 py-3 rounded-lg font-semibold transition-all duration-300 border border-border hover:border-primary"
